...
public class Utils {
	...
	private static ExtendedFixture createExtendedFixture(String team){
...
//		System.out.println(fixtures);
	...
	private static FullEntry createFullEntry(ExtendedFixture i, float prediction, HashMap<ExtendedFixture, FullFixture> map){
	 ...
	 * @param upperValue
	 */
	private static float evaluateForBestSettingsWithParameters(int newStart, int newEnd, int newOffset,
	...
	private static ArrayList<HTEntry> createHTEntry(){
